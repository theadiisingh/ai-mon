...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-emerald-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-content-tertiary mt-2">Sign in to your monitoring dashboard</p>
        </div>
        ...
        <div className="bg-[#11161D]/80 backdrop-blur-xl rounded-xl border border-white/5 p-6 shadow-[0_24px_64px_rgba(0,0,0,0.3)]">
          ...
          <div className="mt-6 pt-5 border-t border-white/5 text-center">
            <p className="text-sm text-content-tertiary">
              ...
              <Link to="/register" className="text-primary hover:text-primary-light font-medium transition-colors duration-150">
                Request Access
              </Link>
            </p>
          </div>
